...
public enum RegulatorDomains implements DomainType {
	...
	// round 1 
	AbrC1("AbrC1","Histidine kinase","AbrC1.hmm",850),
	AbrC2("AbrC2","Histidine kinase","AbrC2.hmm",900),
	AbrC3("AbrC3","Response regulator","AbrC3.hmm",470),
	AbsA1("AbsA1","Histidine kinase","AbsA1.hmm",1200),
	AbsA2("AbsA2","Response regulator","AbsA2.hmm",400),
	AcrR("AcrR","DNA transcription regulator","AcrR.hmm",470),
	ActII_orf4("ActII-orf4","DNA transcription regulator (+)","ActII-orf4.hmm",500),
	ActR("ActR","DNA transcription regulator (-)","ActR.hmm",500),
	AdpA("AdpA","Sequence-specific DNA transcription regulator","AdpA.hmm",880),
	AfsA("AfsA","A-factor biosynthesis enzyme","AfsA.hmm",600),
	AfsQ1("AfsQ1","DNA transcription regulator","AfsQ1.hmm",300),
	AfsQ2("AfsQ2","Histidine kinase","AfsQ2.hmm",300),
	AknO("AknO","DNA transcription regulator (+?)","AknO.hmm",380),
	AlpU("AlpU","DNA transcription regulator - SARP","AlpU.hmm",300),
	AlpV("AlpV","DNA transcription regulator - SARP","AlpV.hmm",420),
	AlpW("AlpW","DNA transcription regulator - TetR","AlpW.hmm",167),
	ArpA("ArpA","DNA transcription regulator (-) - GBL receptor ","ArpA.hmm",500),
	AsfR("AsfR","DNA transcription regulator - LysR-type","AsfR.hmm",1200),
	AsuR5("AsuR5","DNA transcription regulator (+) - BTAD-type","AsuR5.hmm",190),
	AurD("AurD","DNA transcription regulator (+) - BTAD-type","AurD.hmm",170),
	AveR("AveR","Response regulator- LuxR-type","AveR.hmm",1500),
	BafG("BafG","DNA transcription regulator (+) - BTAD-type","BafG.hmm",900),
	BarA("BarA","DNA transcription regulator - TetR","BarA.hmm",205),
	BarX("BarX","A-factor biosynthesis enzyme","BarX.hmm",275),
	BldD("BldD","Sequence-specific DNA transcription regulator","BldD.hmm",377),
	CcaR("CcaR","DNA transcription regulator (+) - BTAD-type","CcaR.hmm",400),
	ChlF2("ChlF2","DNA transcription regulator (+) - BTAD-type","ChlF2.hmm",370),
	CinR1("CinR1","DNA transcription regulator (+) - BTAD-type","CinR1.hmm",205),
	CmmR("CmmR","Hydrolase","CmmR.hmm",270),
	CphR("CphR","DNA transcription regulator (+) - BTAD-type","CphR.hmm",450),
	Cpp1("Cpp1","DNA transcription regulator (+) - BTAD-type","Cpp1.hmm",500),
	Crp("Crp","DNA transcription regulator - cAMP Kinase","Crp.hmm",301),
	CutR("CutR","Response regulator","CutR.hmm",180),
	CutS("CutS","Copper sensor","CutS.hmm",865),
	Cvm7P("Cvm7P","DNA transcription regulator (+) - BTAD-type","Cvm7P.hmm",1500),
	DraK ("DraK ","Histidine kinase","DraK.hmm",100),
	EcrA1("EcrA1","Histidine kinase","EcrA1.hmm",750),
	EcrA2("EcrA2","Response regulator- LuxR-type (CheY superfamily)","EcrA2.hmm",435),
	EcrE2("EcrE2","Response regulator- LuxR-type (CheY superfamily)","EcrE2.hmm",450),
	FarA("FarA","DNA transcription regulator - TetR","FarA.hmm",250),
	FrnG("FrnG","DNA transcription regulator (+) - BTAD-type","FrnG.hmm",215),
	...
	MtmR("MtmR","DNA transcription regulator (+) - BTAD-type","MtmR.hmm",200),
	NanR2("NanR2","DNA transcription regulator (+) - BTAD-type","NanR2.hmm",400),
	NosP("NosP","DNA transcription regulator (+) - BTAD-type","NosP.hmm",250),
	OzmU("OzmU","DNA transcription regulator (+) - BTAD-type","OzmU.hmm",1000),
	PapR2("PapR2","DNA transcription regulator (+) - BTAD-type","PapR2.hmm",600),
	PapR4("PapR4","DNA transcription regulator (+) - BTAD-type","PapR4.hmm",333),
	PapR6("PapR6","Response regulator- LuxR-type","PapR6.hmm",500),
	PieR("PieR","DNA transcription regulator (+) - BTAD-type","PieR.hmm",200),
	PimM("PimM","Response regulator- LuxR-type","PimM.hmm",350),
	PimR("PimR","DNA transcription regulator (+) - BTAD-type","PimR.hmm",1700),
	PlaR("PlaR","DNA transcription regulator (+) - BTAD-type","PlaR.hmm",500),
	PolR("PolR","DNA transcription regulator (+) - BTAD-type","PolR.hmm",500),
	RapA1("RapA1","Response regulator- LuxR-type (CheY superfamily)","RapA1.hmm",460),
	RapA2("RapA2","Histidine kinase","RapA2.hmm",800),
	RedZ("RedZ","Response regulator- LuxR-type (CheY superfamily)","RedZ.hmm",350),
	Rkl("Rkl","DNA transcription regulator - TetR","Rkl.hmm",250),
	RphD("RphD","DNA transcription regulator (+) - BTAD-type","RphD.hmm",230),
	RubS("RubS","DNA transcription regulator (+) - BTAD-type","RubS.hmm",400),
	SamR0468("SamR0468","Response regulator- LuxR-type (CheY superfamily)","SamR0468.hmm",250),
	SanR1("SanR1","DNA transcription regulator (+) - BTAD-type","SanR1.hmm",390),
	ScbA("ScbA","A-factor biosynthesis enzyme","ScbA.hmm",550),
	ScbR("ScbR","DNA transcription regulator (-) - GBL receptor ","ScbR.hmm",350),
	...
	Sky44("Sky44","DNA transcription regulator (+) - BTAD-type","Sky44.hmm",470),
	SscR("SscR","DNA transcription regulator (-) - GBL receptor ","SscR.hmm",350),
	StrR("StrR","Response regulator","StrR.hmm",600),
	...
	DraR("DraR","Two-component <br> Response regulator in S. coelicolor. Positive regulator of ACT, negative of RED and yCPK: DraK","DraR.hmm",200),
	...
	PhoP("PhoP","Two-component <br> Response regulator of S. coelicolor. OmpR-type. Positively regulates RED and ACT through ofsS+ropZ: PhoR, Mg2+","PhoP.hmm",125),
	PhoR("PhoR","Two-component <br> Sensor kinase of S. coelicolor: Phosphate","PhoR.hmm",100),
	...
	RedD("RedD","Pathway-specific <br> Activator of undecylprodigiosin in Streptomyces coelicolor","RedD.hmm",300),
