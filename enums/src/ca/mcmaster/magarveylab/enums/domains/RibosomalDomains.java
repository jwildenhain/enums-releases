...
public enum RibosomalDomains implements DomainType {
	...
	LazA_a("tpdA_a.hmm", "A", "Thiopeptide precursor", 0.0),
	LazA_b("tpdA_b.hmm", "A", "Thiopeptide precursor", 0.0),
	...
	BerH("BerH.hmm", "P450", "Valine &beta;-hydroxylase", 394.0),
	...
	MibO("MibO.hmm", "P450", "Cytochrome P450 proline 3,4-dihydroxylase", 103.0),
	...
	TpdJ1("TpdJ1.hmm", "P450", "Cytochrome P450 (phenylalanine &beta;-hydroxylation "
			+ "or isoleucine epoxidation)", 375.0),
	...
	TsrA("TsrA.hmm", "TsrA", "TsrA-type protein (2-methyltryptophan deaminase)", 50.0),
	...
	TsrE("TsrE.hmm", "TsrE", "TsrE-type protein (methylindole-3-pyruvic acid dehydrogenase)", 50.0),
