...
public enum RibosomalDomains implements DomainType {
	...
	GetJ("GetJ.hmm", "P450", "Cytochrome P450 (hydroxymethylproline biosynthesis)", 250.0),
	...
	NosB("NosB.hmm", "P450", "Cytochrome P450 glutamate &gamma;-hydroxylase", 225.0),
	...
	TsrU("TsrU.hmm", "TsrU", "TsrU-type protein (stereospecific oxidoreductase)", 100.0),
